    ...
    private void init(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            android.content.res.TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    ma.MK.calculator.R.styleable.CalculatorEditText,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(ma.MK.calculator.R.styleable.CalculatorEditText_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(ma.MK.calculator.R.styleable.CalculatorEditText_minTextSize,
                    minTextSize);
            precision = ta.getFloat(ma.MK.calculator.R.styleable.CalculatorEditText_precision, precision);
            ta.recycle();
        }
