package ma.MK.calculator.widget;
...
import ma.MK.calculator.CalculatorExpressionTokenizer;
import ma.MK.calculator.R;
import ma.xlythe.math.Base;
import ma.xlythe.math.BaseModule;
import ma.xlythe.math.Constants;
import ma.xlythe.math.EquationFormatter;
import ma.xlythe.math.Solver;
import ma.xlythe.math.History;
import ma.xlythe.math.Persist;
...
public class CalculatorWidget extends AppWidgetProvider {
    public final static String PREFERENCE_WIDGET_PREAMBLE = "ma.MK.calculator.CALC_WIDGET_VALUE_";
    public static final String DIGIT_0 = "ma.MK.calculator.0";
    public static final String DIGIT_1 = "ma.MK.calculator.1";
    public static final String DIGIT_2 = "ma.MK.calculator.2";
    public static final String DIGIT_3 = "ma.MK.calculator.3";
    public static final String DIGIT_4 = "ma.MK.calculator.4";
    public static final String DIGIT_5 = "ma.MK.calculator.5";
    public static final String DIGIT_6 = "ma.MK.calculator.6";
    public static final String DIGIT_7 = "ma.MK.calculator.7";
    public static final String DIGIT_8 = "ma.MK.calculator.8";
    public static final String DIGIT_9 = "ma.MK.calculator.9";
    public static final String DOT = "ma.MK.calculator.dot";
    public static final String PLUS = "ma.MK.calculator.plus";
    public static final String MINUS = "ma.MK.calculator.minus";
    public static final String MUL = "ma.MK.calculator.mul";
    public static final String DIV = "ma.MK.calculator.div";
    public static final String EQUALS = "ma.MK.calculator.equals";
    public static final String CLR = "ma.MK.calculator.clear";
    public static final String DEL = "ma.MK.calculator.delete";
    public static final String SHOW_CLEAR = "ma.MK.calculator.show_clear";
